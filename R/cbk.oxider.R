#' Convert oxide concentration to values without oxygen
#' @param tbl0 Dataframe generated by cbk.read.casteml
#' @return Dataframe that contains converted columns
#' @export
#' @examples
